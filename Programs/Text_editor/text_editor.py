...
def about():
    showinfo("About this program", "This is in fact a program")
...
frame = Frame(window)
frame.grid()
collor_button = Button(frame, text="Color", command=change_color)
collor_button.grid(row=0,column=0)
